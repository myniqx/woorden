...
const base = 'inline-flex items-center justify-center gap-[var(--spacing-xs)] border font-medium cursor-pointer transition-all duration-[var(--transition-fast)] disabled:opacity-60 disabled:cursor-not-allowed';
...
const sizeMap: Record<Size, string> = {
  sm:   'text-[length:var(--text-xs)] px-[var(--spacing-sm)] py-[var(--spacing-xs)] rounded-[var(--radius-sm)]',
  md:   'text-[length:var(--text-sm)] px-[var(--spacing-md)] py-[var(--spacing-sm)] rounded-[var(--radius-md)]',
  icon: 'text-[length:var(--text-sm)] p-[var(--spacing-sm)] rounded-[var(--radius-sm)] aspect-square',
};
