...
export const fr: Locale = {
  ...
  writing: {
    title: 'Test d\'écriture',
    subtitle: 'Recevez un devoir, écrivez en néerlandais, obtenez une évaluation détaillée',
    level: 'Niveau',
    startButton: 'Commencer',
    generatingAssignment: 'Génération de votre devoir...',
    wordCounter: '{count} / {min} mots',
    submitButton: 'Envoyer',
    submitAnyway: 'Envoyer quand même',
    belowMinTitle: 'Sous le nombre minimum de mots',
    belowMinBody: 'Vous avez écrit {count} / {min} mots. Vous pouvez quand même l\'envoyer — l\'évaluation tiendra compte du texte plus court.',
    reviewingLabel: 'Évaluation de votre texte...',
    tryAgainButton: 'Réessayer',
    scoreOverall: 'Global',
    scoreGrammar: 'Grammaire',
    scoreSpelling: 'Orthographe',
    scoreVocabulary: 'Vocabulaire',
    estimatedLevelLabel: 'Niveau estimé',
    analysisTitle: 'Analyse',
    correctionsTitle: 'Corrections',
    vocabularyTitle: 'Mots utiles',
    submissionTitle: 'Devoir et votre réponse',
    assignmentLabel: 'Devoir',
    yourTextLabel: 'Votre réponse',
    noEntries: 'Aucun test d\'écriture pour le moment',
    backToSetup: 'Retour',
  },
};
